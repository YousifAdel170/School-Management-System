...
// Importing the studentLists configuration for sidebar items
import { studentLists } from "../scripts/config";

/**
 * StudentPage component renders the student page layout with a navigation bar, sidebar,
...
// Exporting the StudentPage component to be used in other parts of the application
